...
\item[Schritt 1] DC-Faktor $100$: Betrag um $+40\,\mathrm{dB}$ nach oben verschoben.
\item[Schritt 2] Nullstelle im Ursprung: Startsteigung $+20\,\mathrm{dB/dec}$ für $\omega\ll1$, Startphase $\approx+90^\circ$.
\item[Schritt 3] Pol bei $\omega_p=1\,\mathrm{rad/s}$: ab $\omega=1$ Steigungswechsel um $-20\,\mathrm{dB/dec}$; für $\omega\gg1$ Betrag $\approx40\,\mathrm{dB}$, Phase fällt gegen $0^\circ$ zwischen $\omega_l=0.1\,\mathrm{rad/s}$ und $\omega_h=10\,\mathrm{rad/s}$.
\end{description}
